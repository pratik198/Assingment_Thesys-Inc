...
function TaskBoards() {
  ...
  const deleteCard = (columnName, card) => {
    setColumns((prevColumns) => ({
      ...prevColumns,
      [columnName]: prevColumns[columnName].filter((c) => c.id !== card.id),
    }));
  };
      ...
      <div className="content_taskboard">
        {Object.entries(columns).map(([columnName, cards]) => (
          ...
          >
            ...
            <div className="content_content_part">
              <div className="first_row" onClick={() => addCard(columnName)}>
                <div className="first_row_img content_icon">
                  <img src={Plus} alt="" />
                </div>
              </div>
              {cards.map((card) => (
                ...
                >
                  <div className="content_task_card_head">
                    ...
                    <div
                      className="delete_btn content_icon"
                      onClick={() => deleteCard(columnName, card)}
                    >
                      <img src={Delete} alt="" />
                    </div>
                  </div>
